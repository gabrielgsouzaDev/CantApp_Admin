    ...
    <div className="flex min-h-screen flex-col bg-background">
        ...
        <section id="hero" className="w-full py-20 md:py-32">
          <div className="container flex flex-col items-center text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl">
              CantApp é a plataforma completa para Escolas e Cantinas que buscam otimizar a gestão de pedidos, pagamentos e produtos. Menos filas, mais controle e resultados para todos.
            </p>
          ...
          <div className="container px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-4xl">
                <DialogHeader>
                  <DialogTitle className="text-2xl font-headline">A Jornada do Pedido no CantApp</DialogTitle>
                </DialogHeader>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-12 gap-4">
              <div className="text-center sm:text-left">
                ...
                <p className="text-muted-foreground text-lg mt-2 max-w-2xl">
                  Descubra como o CantApp transforma a gestão para cada perfil.
                </p>
              </div>
              ...
              <div className="md:col-span-2">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      <div className="prose prose-sm text-muted-foreground max-w-none">
                        ...
                        <p className="mt-2">
                          Ele também pode comprar diretamente no intervalo, pagando com Pix ou com o saldo pré-pago disponível em sua conta CantApp.
                        </p>
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                      <div className="prose prose-sm text-muted-foreground max-w-none">
                       O CantApp oferece ferramentas para que você gerencie os hábitos alimentares do seu filho de forma personalizada:
                  ...
                  <AccordionItem value="item-3">
                    <AccordionTrigger>Quero usar o CantApp, quanto custa?</AccordionTrigger>
                    <AccordionContent>
      ...
      <footer className="border-t">
        <div className="container mx-auto py-8 text-center text-sm text-muted-foreground px-4 sm:px-6 lg:px-8">
          © {new Date().getFullYear()} CantApp. Todos os direitos reservados.
        </div>
      </footer>
    </div>
  );
